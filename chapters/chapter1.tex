...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption[Comparison of the Energy Consumption of Various LLMs]{Comparison of the energy consumption of different LLMs for small and large queries. The data highlights the significant increase in energy requirements as query size grows. These graphs have been sourced from \cite{hungry_ai}.}
